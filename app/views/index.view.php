<main>
    <h1></h1>
    <!-- modal de los paquetes -->
    <?php require "partials/modalPackage.php" ?>
    <!-- seccion del banner y formulario -->
    <section>
        <div id="bannerForm">
            <img src="public/img/banner-index.png" alt="bannerIndex">
            <form action="app/model/contactAssessor.php" method="get" id="formIndex">
                <fieldset>
                    ...
                    <div class="campoForm">
                        ...
                        <div class="contenedorFecha">
                            <label for="idaM">Fecha de salida</label>
                            <input type="date" name="idaM" id="idaM" onkeydown="return false;" onclick="this.showPicker();" required />
                        </div>
                        <div class="contenedorFecha">
                            <label for="vueltaM">Fecha de retorno</label>
                    ...
                    <div class="campoForm pasajeros">
                        <caption>Pasajeros</caption>
                        <div>
                            <label for="adultosM">Adultos:</label>
                            <input type="number" name="adultosM" id="adultosM" value=1 min=0 max=10 step=1 >
                        </div>
                        <div>
                            <label for="niniosM">Niños:<span class="niniosSpan" id="spanNinios" title="Menores de 2 años">?</span></label>
                            <div id="titlePopup"></div>
                            <input type="number" name="niniosM" id="niniosM" min=0 max=10 step=1 placeholder=0>
                        </div>
                        <div>
                            <label for="mascotasM">Mascotas:</label>
                            <input type="number" name="mascotasM" id="mascotasM" min=0 max=10 step=1 placeholder=0>
                        </div>
                    </div>
    ...
    <!-- barra de navegacion en el cuerpo del index -->
    <div id="navIndex">
        <nav>
    ...
    <section class="sectionSlides" id="internacionales">
        ...
        <div class="slider">
                <div class="slide">
                    <div class="card">
                        <img src="public/img/internacionales/aruba.jpg" alt="aruba">
                        <button class="btn_package" data-id_package="1">Ver mas...</button>
                    </div>
                </div>
                <div class="slide">
                    <div class="card">
                        <img src="public/img/internacionales/barcelona.jpg" alt="barcelona">
                        <button class="btn_package" data-id_package="2">Ver mas...</button>
                    </div>
                </div>
                <div class="slide">
                    <div class="card">
                        <img src="public/img/internacionales/madrid.jpg" alt="madrid">
                        <button class="btn_package" data-id_package="3">Ver mas...</button>
                    </div>
                </div>
                <div class="slide">
                    <div class="card">
                        <img src="public/img/internacionales/mexico.jpg" alt="mexico">
                        <button class="btn_package" data-id_package="4">Ver mas...</button>
                    </div>
                </div>
                <div class="slide">
                    <div class="card">
                        <img src="public/img/internacionales/paris.jpg" alt="paris">
                        <button class="btn_package" data-id_package="5">Ver mas...</button>
                    </div>
                </div>
                <div class="slide">
                    <div class="card">
                        <img src="public/img/internacionales/portugal.jpg" alt="portugal">
                        <button class="btn_package" data-id_package="6">Ver mas...</button>
                    </div>
                </div>
                <div class="slide">
                    <div class="card">
                        <img src="public/img/internacionales/rio.jpg" alt="rio">
                        <button class="btn_package" data-id_package="7">Ver mas...</button>
                    </div>
                </div>
                <div class="slide">
                    <div class="card">
                        <img src="public/img/internacionales/roma.jpg" alt="roma">
    ...
    <section class="sectionSlides" id="nacionales">
        ...
        <div class="slider">
                <div class="slide">
                    <div class="card">
                        <img src="public/img/nacionales-argentina/bariloche.jpg" alt="bariloche">
                        <button class="btn_package" data-id_package="9">Ver mas...</button>
                    </div>
                </div>
                <div class="slide">
                    <div class="card">
                        <img src="public/img/nacionales-argentina/iguazu.jpg" alt="iguazu">
                        <button class="btn_package" data-id_package="10">Ver mas...</button>
                    </div>
                </div>
                <div class="slide">
                    <div class="card">
                        <img src="public/img/nacionales-argentina/mendoza.jpg" alt="mendoza">
                        <button class="btn_package" data-id_package="11">Ver mas...</button>
                    </div>
                </div>
                <div class="slide">
                    <div class="card">
                        <img src="public/img/nacionales-argentina/salta.jpg" alt="salta">
